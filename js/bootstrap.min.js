 ...
 */
if ("undefined" == typeof AJS.$)throw new Error("Bootstrap's JavaScript requires AJS.$");
+function (a) {
    "use strict";
    var b = a.fn.jquery.split(" ")[0].split(".");
    if (b[0] < 2 && b[1] < 9 || 1 == b[0] && 9 == b[1] && b[2] < 1)throw new Error("Bootstrap's JavaScript requires AJS.$ version 1.9.1 or higher")
}(AJS.$), +function (a) {
    "use strict";
    function b() {
